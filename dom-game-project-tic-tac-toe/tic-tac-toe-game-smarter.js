...
function aiMove(positions, globalPositions) {
  var moveMade = false;
  while (!moveMade && positions.length > 0) {
    ...
    if (document.querySelector(positions[moveToTry]).innerText === "") {
      ...
      globalPositions.splice(moveToTry, 1);
      moveMade = true;
      return true
    }
    else {
...
function smarterAIMove(humanLetter, awesomeAILetter){
  var awesomeAITokenCount = 0;
  if (document.querySelector("#x0y2").innerText === awesomeAILetter){
    awesomeAITokenCount += 1;
  }
  if (document.querySelector("#x1y2").innerText === awesomeAILetter){
    awesomeAITokenCount += 1;
  }
  if (document.querySelector("#x2y2").innerText === awesomeAILetter){
    awesomeAITokenCount += 1;
  }
  if (awesomeAITokenCount === 2) {
    tempPositions = ["#x0y2", "#x1y2", "#x2y2"]
    if (aiMove(tempPositions, boardPositions)) {
      alert("Oh snap!!!");
      return true;
    }
  }
  var awesomeAITokenCount = 0;
  if (document.querySelector("#x0y1").innerText === awesomeAILetter){
    awesomeAITokenCount += 1;
  }
  if (document.querySelector("#x1y1").innerText === awesomeAILetter){
    awesomeAITokenCount += 1;
  }
  if (document.querySelector("#x2y1").innerText === awesomeAILetter){
    awesomeAITokenCount += 1;
  }
  if (awesomeAITokenCount === 2) {
    tempPositions = ["#x0y1", "#x1y1", "#x2y1"]
    if (aiMove(tempPositions, boardPositions)) {
      alert("Oh snap!!!");
      return true;
    }
  ...
  var awesomeAITokenCount = 0;
  if (document.querySelector("#x0y0").innerText === awesomeAILetter){
    awesomeAITokenCount += 1;
  }
  if (document.querySelector("#x1y0").innerText === awesomeAILetter){
    awesomeAITokenCount += 1;
  }
  if (document.querySelector("#x2y0").innerText === awesomeAILetter){
    awesomeAITokenCount += 1;
  }
  if (awesomeAITokenCount === 2) {
    tempPositions = ["#x0y0", "#x1y0", "#x2y0"]
    if (aiMove(tempPositions, boardPositions)) {
      alert("Oh snap!!!");
      return true;
    }
  ...
  if (awesomeAITokenCount === 2) {
    tempPositions = ["#x2y0", "#x1y1", "#x0y2"]
    if (aiMove(tempPositions, boardPositions)) {
      alert("Oh snap!!!");
      return true;
    }
  }
  var humanTokenCount = 0;
  if (document.querySelector("#x0y2").innerText === humanLetter){
    humanTokenCount += 1;
  }
  if (document.querySelector("#x1y2").innerText === humanLetter){
    humanTokenCount += 1;
  }
  if (document.querySelector("#x2y2").innerText === humanLetter){
    humanTokenCount += 1;
  }
  if (humanTokenCount === 2) {
    tempPositions = ["#x0y2", "#x1y2", "#x2y2"]
    if (aiMove(tempPositions, boardPositions)) {
      alert("Oh snap!!!");
      return true;
  ...
  var humanTokenCount = 0;
  if (document.querySelector("#x0y1").innerText === humanLetter){
    humanTokenCount += 1;
  }
  if (document.querySelector("#x1y1").innerText === humanLetter){
    humanTokenCount += 1;
  }
  if (document.querySelector("#x2y1").innerText === humanLetter){
    humanTokenCount += 1;
  }
  if (humanTokenCount === 2) {
    tempPositions = ["#x0y1", "#x1y1", "#x2y1"]
  ...
  var humanTokenCount = 0;
  if (document.querySelector("#x0y0").innerText === humanLetter){
    humanTokenCount += 1;
  }
  if (document.querySelector("#x1y0").innerText === humanLetter){
    humanTokenCount += 1;
  }
  if (document.querySelector("#x2y0").innerText === humanLetter){
    humanTokenCount += 1;
  }
  if (humanTokenCount === 2) {
    tempPositions = ["#x0y0", "#x1y0", "#x2y0"]
...
document.getElementById("x0y2").addEventListener("click", function (event) {
  if (document.querySelector("#x0y2").innerText === "" && boardPositions.length > 0 && !checkForWin(boardPositions)) {
    ...
    if (!checkForWin(boardPositions)) {
      smarterAIMove(XOrO, opponentLetter);
